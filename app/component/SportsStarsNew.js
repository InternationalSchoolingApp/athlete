...
const SportsStars = () => {
  return (
    <>
      <div className=" grid grid-cols-2  lg:grid-cols-4 lg:divide-x lg:divide-blue-700 bg-[#0E083F] mt-10 p-5 md:p-10  justify-between items-center rounded-3xl gap-4 lg:gap-0">
