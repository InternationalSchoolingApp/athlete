    ...
    <div className="relative max-w-screen overflow-x-hidden">
      <div className="w-full z-20 bg-white/50 backdrop-blur sticky top-0 right-0 left-0 shadow">
        <header className="r-w  flex items-center justify-between py-2 ">
          ...
          <Link
            href={"#form"}
            className="btn bg-blue-600 text-white hover:text-blue-600 duration-300 uppercase"
          >
            Talk to us
          </Link>
        </header>
      ...
      <Image
        priority
        alt="globe"
        className="absolute md:opacity-80 -z-10 animate-spin right-0  w-[300px] h-[300px] md:w-[800px] md:h-[800px] top-0 "
        src={"/globe.png"}
        width={400}
        height={400}
      />
      <div className="z-10 r-w lg:flex lg:items-center gap-5 py-4 md:py-12">
        <div className="w-full mb-4 lg:mb-0 ">
          <h2 className="mb-2 font-bold text-3xl md:text-5xl text-blue-600">
            #Top Rated{" "}
          </h2>
          <h1 className="text-blue-700 text-2xl md:text-4xl font-semibold">
            American Online School
          </h1>
          <h2 className=" font-semibold text-xl md:text-3xl text-blue-600">
          ...
          <div className="relative">
            <Image
              priority
              alt="shout"
              className="absolute w-4 md:w-[30px] h-auto contrast-20 saturate-20 grayscale brightness-50 -left-3 md:-left-10 top-[2px] md:-top-2"
              src={"/shout.png"}
              width={30}
              height={30}
            />
            <h3 className="pl-2 md:pl-0 text-xl font-semibold  md:text-3xl text-blue-900  ">
              Your
              <FlipWords duration={1000} words={words} />
            </h3>
          </div>
          <h3 className="text-5xl leading-[1.18] font-black md:mb-2 bg-gradient-to-r from-[#001FCF] to-red-600 inline-block text-transparent bg-clip-text g-t">
            Upto 20% Discount
          </h3>
          <p className="mb-2 md:mb-6 text-justify text-sm ">
            International Schooling, accredited by Cognia, USA and approved by
            National Collegiate Athletic Association (NCAA) and College Board is
            the most recommended and trusted online school. We are serving over
            3500 student athletes from 135+ countries, playing more than 50
            sports.
          </p>
          <Link
            href={"#form"}
            className="btn bg-blue-600 text-white hover:text-blue-600 duration-300"
          >
            Lets Connect
          </Link>
        </div>
      ...
      <div className="md:border-y md:backdrop-blur-sm md:mt-8 lg:mt-0">
        <div className="r-w grid grid-cols-2 md:grid-cols-5 items-center justify-center gap-4 lg:gap-10 py-2 px-2">
          <div className=" md:origin-left mb-2 md:mb-0 font-bold text-blue-800 text-5xl md:text-2xl col-span-2 md:col-span-1 text-end md:text-start">
            <h2>Approved</h2>
            <h2>Accredited</h2>
            <h2>Recognized</h2>
          </div>
      ...
      <div className="grid md:grid-cols-2 gap-4 r-w py-6 content-center">
        <div className="w-full h-max self-center">
          <h2 className="text-4xl md:text-6xl bg-gradient-to-r from-[#001FCF] to-red-600 text-transparent bg-clip-text g-t text-center md:text-start font-black mb-3 md:mb-6">
            Scholarships
          </h2>
          <h2 className="text-2xl md:text-4xl font-black py-4 px-4 origin-left mb-2 md:mb-0 md:hover:rotate-0 md:duration-300 md:rotate-2  border border-blue-300 bg-blue-50 text-blue-800 rounded-xl">
            10% Province Level
          </h2>
          <h2 className="text-2xl md:text-4xl font-black py-4 px-4 origin-left mb-2 md:mb-0 border border-blue-300 bg-blue-200 text-blue-800 rounded-xl">
            15% National Level
          </h2>
          <h2 className="text-2xl mb-4 md:text-4xl font-black py-4 px-4 origin-left md:hover:rotate-0 md:duration-300 md:-rotate-3  border bg-blue-300 text-blue-900 rounded-xl">
            20% International Level
          </h2>
          <Link
            href={"#form"}
            className="shadow  w-full md:w-max text-center btn bg-blue-600 text-white hover:text-blue-600 duration-300 "
          >
            Connect with us
          </Link>
        </div>
      ...
      <div className="py-2 r-w grid md:grid-cols-3 gap-4 ">
        <div className="md:col-span-2 ">
          <h2 className="mb-2 md:mb-6 font-bold text-4xl md:text-5xl bg-gradient-to-r from-[#001FCF] to-red-600 text-transparent bg-clip-text g-t inline-block">
            Why Choose Us?
          </h2>
          <div className="  flex flex-col md:flex-row items-center  md:gap-5 py-2 ">
            ...
            <div>
              ...
              <p className="text-justify text-xs md:text-[16px] md:leading-[1.2em]">
                We understand every student has different learning needs and
                varying schedules. Acknowledging the diverse learning
                requirements of every student, International Schooling tailors
                lesson plans and study hours to suit their individual needs.
              </p>
            </div>
          </div>
          <div className="  flex flex-col md:flex-row items-center  md:gap-5 py-2 ">
            ...
            <div>
              ...
              <p className="text-justify text-xs md:text-[16px] md:leading-[1.2em]">
                International Schooling has over 600+ teachers from over 50
                counties, speaking 40+ languages who have extensive experience
          ...
          <div className="  flex flex-col md:flex-row items-center  md:gap-5 py-2 ">
            ...
            <div>
              ...
              <p className="text-justify text-xs md:text-[16px] md:leading-[1.2em]">
                International Schooling offers American Curriculum from grades
                KG-12 and awards the prestigious American High School Diploma.
                Our academic programs are designed to prepare your child for
          ...
          <div className="mb-4  flex flex-col md:flex-row items-center  md:gap-5 py-2">
            ...
            <div>
              ...
              <p className="text-justify text-xs md:text-[16px] md:leading-[1.2em]">
                The flexibility offered by International Schooling caters to
                varied schedules, fosters personalized learning environments,
                adjusts to individual learning paces and, accommodates the
                diverse learning styles of its students.
              </p>
            </div>
          </div>
        </div>
        <div id="form">
          <h2 className="font-bold text-3xl text-blue-800 text-center">
            Fill this form
          </h2>
      ...
      <div className="r-w  bg-blue-600 rounded-3xl p-4 md:p-10">
        ...
        <div className=" grid grid-cols-2   lg:grid-cols-4 lg:divide-x  lg:divide-blue-700 mt-10   justify-between items-center rounded-3xl gap-4 lg:gap-0">
      ...
      <div className="r-w grid md:grid-cols-3 mb-8 items-center gap-2 md:gap-12 py-6">
        <div className="w-full md:col-span-2">
          <h2 className="text-blue-600 mb-3 font-bold text-xl md:text-2xl">
            The Right School For{" "}
            <span className="text-5xl bg-gradient-to-r from-[#001FCF] to-red-600 text-transparent bg-clip-text g-t">
              <br />
              Future Champions :
            </span>
          </h2>
          ...
          <ul className="list-disc space-y-2 mb-4 text-sm text-justify">
            <li>
              Over 3500 athletes from our student community are playing at
              International, National and Province levels.{" "}
              <span className="text-green-600">
                3500 athletes from our student community playing
              </span>{" "}
              at International, National and Province levels.
            </li>
            <li>
              We offer{" "}
              <span className="text-green-600">
                free counselling on sports psychology and injury management
              </span>{" "}
              to our student athletes.
            </li>
            <li>
              We help our student athletes balance their{" "}
              <span className="text-green-600">
                academics and training perfectly.
              </span>
            </li>
            <li>
              We customize lesson plans and study hours to help our young
              sportspersons{" "}
              <span className="text-green-600">excel in academics.</span>
            </li>
          </ul>
          <Link
            href={"#form"}
        ...
        <div>
          ...
          <div className="-mt-7 text-center bg-gradient-to-r from-[#001FCF] to-red-600 py-2 px-4 rounded-xl text-white origin-left  -rotate-6">
            ...
            <p>
              Winning <b>GOLD Medals</b> & doing perfect in academics
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="r-w py-6">
        ...
        <div className="grid  md:grid-cols-3 gap-3">
          <div className="w-full p-4 hover:shadow-xl duration-300 flex flex-col  border rounded-xl bg-gray-100">
            <p className="text-sm mb-2 text-justify flex-1">
              ...
              the One-To-One teaching method. Thank you International Schooling.
            </p>
