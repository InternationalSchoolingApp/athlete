...
const Page = () => {
    ...
    return (
        <div className="min-h-screen relative max-w-screen overflow-x-hidden">
            ...
            <Image className='absolute md:opacity-80 -z-10 animate-spin right-0  w-[300px] h-[300px] md:w-[800px] md:h-[800px] top-0 ' src={"/globe.png"} width={400} height={400} />
            ...
            <div className='grid md:grid-cols-2 gap-4 r-w py-6 content-center'>
                ...
                <Image width={500} height={500} src={"/583_c.webp"} className='w-full h-auto'></Image>
            ...
            <div className='py-2 r-w grid md:grid-cols-3 gap-4 '>
                <div className='md:col-span-2 '>
                    ...
                    <div className='  flex flex-col md:flex-row  md:gap-5 py-2 '>
                        <div className='w-[108px] h-[108px] flex items-center justify-center rounded-xl border mb-4 md:mb-0 shadow bg-gray-50 p-4'>
                        ...
                        <div>
                            ...
                            <p className='text-justify'>We understand every student has different learning needs and varying schedules. Acknowledging the diverse learning requirements of every student, International Schooling tailors lesson plans and study hours to suit their individual needs.</p>
                        </div>
                    </div>
                    <div className='  flex flex-col md:flex-row  md:gap-5 py-2 '>
                        <div className='w-[108px] h-[108px] flex items-center justify-center rounded-xl border mb-4 md:mb-0 shadow bg-gray-50 p-4'>
                        ...
                        <div>
                            <h3 className='text-xl font-semibold text-violet-600'>Internationally Trained and Certified Teachers:</h3>
                            <p className='text-justify'>International Schooling has over 600+ teachers from over 50 counties, speaking 40+ languages who have extensive experience and expertise in their respective fields.</p>
                        </div>
                    </div>
                    <div className='  flex flex-col md:flex-row  md:gap-5 py-2 '>
                        <div className='w-[108px] h-[108px] flex items-center justify-center rounded-xl border mb-4 md:mb-0 shadow bg-gray-50 p-4'>
                        ...
                        <div>
                            ...
                            <p className='text-justify'>International Schooling offers American Curriculum from grades KG-12 and awards the prestigious American High School Diploma. Our academic programs are designed to prepare your child for success in college and beyond.</p>
                        </div>
                    </div>
                    <div className='mb-4  flex flex-col md:flex-row  md:gap-5 py-2'>
                        ...
                        <div>
                            ...
                            <p className='text-justify'>The flexibility offered by International Schooling caters to varied schedules, fosters personalized learning environments, adjusts to individual learning paces and, accommodates the diverse learning styles of its students.</p>
                        </div>
                    </div>
                </div>
                <div>
            ...
            <div className='r-w grid md:grid-cols-3 mb-8 items-center gap-2 py-6'>
                ...
                <div>
                    <Image width={400} height={400} src={ImagePath.HERO_IMG} className='h-auto w-full'></Image>
